...
def Dicke_classical_eqsmot_second_order(t, v, wz, wc, lam):
    ...
    dv[7] = -4*lam*v[0]*v[1]*v[3] + 2*lam*v[0]*v[13] + 2*lam*v[1]*v[8] + 2*lam*v[3]*v[6] # mx mz
    ...
    dv[14] = wz*v[9] + wc*v[13] + 4*lam*v[2]*v[3]*v[4] - 2*lam*v[2]*v[21] - 2*lam*v[3]*v[19] -2*lam*v[4]*v[18] + 2*lam*v[6] # my p
    ...
    dv[19] = wc*v[18] - 4*lam*v[1]*v[3]*v[4] + 2*lam*v[1]*v[21] + 2*lam*v[3]*v[14] + 2*lam*v[4]*v[13] + 2*lam*v[7] # mz p
